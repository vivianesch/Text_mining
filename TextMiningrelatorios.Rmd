...
F22 <- c("riscos", "avaliação", "verificação", "análise", "avaliou", "avaliaram")
...
vetores_fatores <- sprintf(F22, F28, F29, F51, F52, F56, F57, F58, F61, F87, F104, F105, F118)

## S3 method for class 'list' to transforma a df
as.data.frame(F104, row.names = NULL, optional = FALSE,
...
tb_P20 <- .Analise_fatores_tb(P20, "Incendío")
