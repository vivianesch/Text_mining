...
# Arquivo pdf
arquivoPdf <- "C:/Users/Jacob/Documents/Text Mining/GrupoP66.pdf"
...
my_stopwords <- tibble(Palavra = c(as.character(1:3), 
                                    "www","http", ",", "de","os","nao","da","sao","um","dos","em","para","possui","sobre","das","na","uma","se","não", "outro", "entao", "existem", "outros", "aos", "quando", "seus", "seu", "nas", "na","evitar", "possuem", "ou", "sua", "então", "podem", "esta", "bem", "ha", "há","forem", "documentadas", "documentados", "alta", "entrevistado", "francisco"))
